        ...
        <div>
          ...
          <div className="space-y-2">
            {recentCanvases.length === 0 ? (
              ...
              <Link key={canvas.id} href={`/canvas/${canvas.id}`} className="group flex items-center justify-between p-3.5 rounded-xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] hover:shadow-sm hover:border-[hsl(var(--ring)/0.2)] transition-all">
        ...
        <div>
          ...
          <div className="space-y-2">
            {ownedWorkspaces.length === 0 ? (
              ...
              <Link key={ws.id} href={`/workspaces/${ws.id}`} className="group flex items-center gap-3 p-3.5 rounded-xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] hover:shadow-sm hover:border-[hsl(var(--ring)/0.2)] transition-all">
